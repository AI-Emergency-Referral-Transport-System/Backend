...
EMERGENCY_AMBULANCE = env("EMERGENCY_AMBULANCE", "907")
EMERGENCY_POLICE = env("EMERGENCY_POLICE", "991")
EMERGENCY_FIRE = env("EMERGENCY_FIRE", "939")

DEFAULT_AMBULANCE_SEARCH_RADIUS_KM = int(env("DEFAULT_AMBULANCE_SEARCH_RADIUS_KM", "50"))
MAX_AMBULANCE_SEARCH_RADIUS_KM = int(env("MAX_AMBULANCE_SEARCH_RADIUS_KM", "100"))
